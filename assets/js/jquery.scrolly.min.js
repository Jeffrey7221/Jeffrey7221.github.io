...
(function (e) {
    ...
    e.fn.scrolly = function (i) {
        ...
        // Adjust speed of scroll based on where to go
        var scrollSpeed;
        if (f == "#one") scrollSpeed = 1e3; 
        else if (f == "#two") scrollSpeed = 2e3; 
        else if (f == "#three") scrollSpeed = 3e3;
        else if (f == "#footer") scrollSpeed = 35e2;
        // Variable scrollSpeed is set to how many seconds for the scroll
